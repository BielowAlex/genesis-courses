...
const Rating: React.FC<IProps> = ({ rate }) => {
  React.useEffect(() => {

  });
  return (
    <div className="course-rate">
      <span className="course-rate__count">{rate}</span>
      {[...new Array(5)].map((_, index) => (
        rate >= index + 1 ? (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className="course-rate__star" key={Math.random()}>
            <path

...
import './CoursePlayerError.scss';

interface IProps {
  isVideoLoaded:boolean
}

const CoursePlayerError:React.FC<IProps> = ({ isVideoLoaded }) => (
  <div className="course-lessons__player-error" style={{ display: isVideoLoaded ? 'none' : 'flex' }}>
    <div className="course-lessons__player-error__back">
    ...
    <h2 className="course-lessons__player-error__title">Video not found</h2>
    <p className="course-lessons__player-error__desc">
      Failed to upload video, please
      <br />
      try again later
    </p>
    <Link to="/courses" className="course-lessons__player-error__btn">Back to courses</Link>
  </div>
);
